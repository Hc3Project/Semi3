...
/**
 * Servlet implementation class ReviewerRankServlet
 */
@WebServlet("/rvrRank.rvr")
public class ReviewerRankServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewerRankServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReviewerInfo> result = rs.selectReviewerRank();
